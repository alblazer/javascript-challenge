...
tableData.forEach((ufo) => {
	...
	Object.entries(ufo).forEach(([d, i]) => {
		var cell = row.append("td");
		cell.text(value);
	})
})

// Create arrays to store distinct objects in abc order
...
// Dynamically add objects to corresponding menus
...
// Create event handlers for the form's inputs and dropdown selections
d3.selectAll(".form-control").on("change", updateFilters);

//Create event handlers for the button Clear Filter
